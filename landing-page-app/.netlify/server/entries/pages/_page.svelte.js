...
import { H as Header, C as CTAs } from "../../chunks/Header.js";
...
const ProductCard = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="grid grid-cols-1 md:grid-cols-2 gap-14 md:gap-14 lg:gap-20 text-base"><div${add_attribute("class", "flex flex-col gap-8 md:gap-10 pt-8 sm:pt-10" + (index % 2 === 1 ? " md:order-2" : " "), 0)}><h4 class="text-2xl sm:text-3xl md:text-4xl ma-w-[1000px] w-full font-medium relative after:absolute after:top-full after:left-0 after:w-1/5 after:h-1.5 after:mt-1 after:bg-slate-900">${slots.default ? slots.default({}) : ``}</h4> <p>${escape(productFeature.description)}</p> <div class="flex flex-col gap-3">${each(productFeature.featureList, (listItem) => {
    return `<div class="flex gap-2 items-center"><div class="grid place-items-center px-1.5 text-xs sm:text-sm aspect-square rounded-full border-[1.5px] bg-white border-solid border-green-solid" data-svelte-h="svelte-1spj9fq"><i class="fa-solid fa-bolt text-green-400"></i></div> <p>${escape(listItem)}</p> </div>`;
  })}</div> <div class="flex items-center" data-svelte-h="svelte-nnp6r2"><button class="specialBtnDark mr-auto font-semibold"><p>Try free today →</p></button></div></div> <div${add_attribute("class", "flex flex-col dropShadow overflow-hidden rounded-b-lg", 0)}><div class="rounded-t-xl h-8 sm:h-10 bg-white opacity-60 px-3 flex items-center gap-2">${each([1, 2, 3], (i) => {
...
const Product = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(SectionWrapper, "SectionWrapper").$$render($$result, { id: "product" }, {}, {
    default: () => {
      return `<div class="flex flex-col gap-10 sm:gap-14 md:gap-24 flex-1 items-center justify-center pb-10 md:pb-14"><div class="flex flex-col gap-2" data-svelte-h="svelte-1kum5xs"><p class="opacity-60 text-base sm:text-lg md:text-xl text-center">Start your lifetime <span class="text-indigo-400">gym streak</span> today</p> <h3 class="text-4xl sm:text-5xl lg:text-6xl max-w-[1000px] mx-auto w-full font-semibold text-center">Features For Everyone</h3></div> ${each(productFeatures, (productFeature, index) => {
        return `${validate_component(ProductCard, "ProductCard").$$render($$result, { productFeature, index }, {}, {
          default: () => {
            return `${index === 0 ? `Experience beginner exercise <span class="text-indigo-400 font-medium" data-svelte-h="svelte-19fzx1t">master</span> class` : `${index === 1 ? `Lay the foundation for <span class="text-indigo-400 font-medium" data-svelte-h="svelte-y7ya4f">routine</span> and consistency` : `Workout specific to your <span class="text-indigo-400 font-medium" data-svelte-h="svelte-obi5bg">environment</span> and
...
const ReviewCard = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div${add_attribute(
    "class",
    "flex flex-col gap-2 w-full max-w-[500ox] mx-auto relative " + (left ? index % 2 === 1 ? "hidden md:flex opacity-0 pointer-events-none max-h-[40px] overflow-hidden" : " " : index % 2 === 0 ? "hidden md:flex opacity-0 pointer-events-none max-h-[40px] overflow-hidden" : " "),
    0
...
const Conversion = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<section class="py-14 md:py-20 flex flex-col gap-8 bg-[#181b34] text-white text-center text-center items-center justify-center"><h4 class="text-xl sm:text-2xl md:text-3xl poppins" data-svelte-h="svelte-1i1qneq">Reach your fitness <span class="poppins font-bold">goals and aspirations</span></h4> <p class="poppins text-base sm:text-lg md:text-xl" data-svelte-h="svelte-5icryj">+ Unlimited time on Free plan +</p> ${validate_component(CTAs, "CtAs").$$render($$result, { dark: true }, {}, {})}</section>`;
});
